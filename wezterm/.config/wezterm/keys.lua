...
return {
	...
	keys = {
		...
		{ key = "f", mods = mods.l, action = act.ToggleFullScreen },
		...
		{ key = "}", mods = key_mod_panes, action = act({ ActivateTabRelative = 1 }) },
		{ key = "x", mods = mods.l, action = act({ CloseCurrentPane = { confirm = true } }) },
		{ key = "s", mods = mods.l, action = act.PaneSelect({ mode = "SwapWithActiveKeepFocus" }) },
